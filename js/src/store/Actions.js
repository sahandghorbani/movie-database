...
export default {
    getMoviesBySearch({commit , state}, payload) {
        state.loading = true
        axios
      ...
      getMoviesByDatePicker({commit , state}, payload) {
        // console.log(payload);
     ...
     async FetchMovieDetail({commit , state} , payload) {
      state.loading = true
      await axios
      ...
      async FetchMovieStars({commit} , payload) {
        await axios
      ...
      async FetchTrendingMovies({commit , state}) {
        state.loading = true
        await axios
